...
FactoryGirl.define do
  factory :vcr_bancbox_escrow, :class => 'Bancbox::Escrow::Base' do
  ...
  factory :vcr_established_bancbox_escrow, :class => 'Bancbox::Escrow::Base' do
    name "Test"
  ...
  factory :kyle_bancbox_escrow, :class => 'Bancbox::Escrow::Base' do
    name "Kyle Oa"
    start_date Date.today + 1
