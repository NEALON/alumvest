class QuestionnairesController < ApplicationController
  ...
  def new
    ...
    unless @investment_finalization.questionnaire
      Questionnaire.create(:investment_finalization => @investment_finalization)
    end
    redirect_to campaign_investment_finalization_questionnaire_path(@campaign, @investment_finalization)
  end
